...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0802cee8", Component.options)
  } else {
    hotAPI.reload("data-v-0802cee8", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__routes_js__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__views_books_Create_vue__ = __webpack_require__(40);
...
Component.options.__file = "resources/js/views/books/Create.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7e5af7c0", Component.options)
  } else {
    hotAPI.reload("data-v-7e5af7c0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(11)("658b4c1a", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(11)("efd09b72", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "create-book" },
    [
      _c("h3", [_vm._v("Create new book")]),
      _vm._v(" "),
      _c("div", { staticClass: "create-book-container" }, [
        _c(
          "form",
          {
            attrs: { method: "POST" },
          ...
          [
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("span", {
                ...
                domProps: { textContent: _vm._s(_vm.errors.get("price")) }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.book.type_id,
                    expression: "book.type_id"
                  }
                ],
                staticClass: "form-control",
                ...
                on: {
                  input: function($event) {
                    ...
                    _vm.$set(_vm.book, "type_id", $event.target.value)
                  }
                }
              }),
              _vm._v(" "),
                ...
                directives: [
                  {
                    name: "show",
                    rawName: "v-show",
                    value: _vm.errors.has("type_id"),
                    expression: "errors.has('type_id')"
                  }
                ],
                staticClass: "text-danger",
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.book.year_published,
                    expression: "book.year_published"
                  }
                ],
                staticClass: "form-control",
                attrs: { type: "text", id: "year_published" },
                domProps: { value: _vm.book.year_published },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.book, "year_published", $event.target.value)
                  }
                }
              }),
              _vm._v(" "),
                ...
                directives: [
                  {
                    name: "show",
                    rawName: "v-show",
                    value: _vm.errors.has("year_published"),
                    expression: "errors.has('year_published')"
                  }
                ],
                staticClass: "text-danger",
                domProps: {
                  textContent: _vm._s(_vm.errors.get("year_published"))
                }
              })
            ]),
            _vm._v(" "),
              ...
              _c("input", {
                ...
                on: {
                  input: function($event) {
                    ...
                    _vm.$set(_vm.book, "edition", $event.target.value)
                  }
                }
              })
            ]),
      ...
      _vm._v(" "),
      _c("router-link", { attrs: { to: "/books" } }, [_vm._v("Cancel")])
    ],
    1
  )
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Pager_vue__ = __webpack_require__(12);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0802cee8", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("pager", {
        attrs: { uri: "/books", total_pages: _vm.page_count },
...
Component.options.__file = "resources/js/views/books/Book.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-45fc928d", Component.options)
  } else {
    hotAPI.reload("data-v-45fc928d", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-45fc928d", module.exports)
  }
}
...
Component.options.__file = "resources/js/views/publishers/Index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ace8face", Component.options)
  } else {
    hotAPI.reload("data-v-ace8face", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ace8face", module.exports)
  }
}
...
Component.options.__file = "resources/js/views/publishers/PublisherList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9f4220fe", Component.options)
  } else {
    hotAPI.reload("data-v-9f4220fe", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Pager_vue__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Pager_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_Pager_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Create_vue__ = __webpack_require__(67);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        pager: __WEBPACK_IMPORTED_MODULE_0__components_Pager_vue___default.a,
        publisherForm: __WEBPACK_IMPORTED_MODULE_1__Create_vue___default.a
    },
    data: function data() {
        return {
            publishers: [],
    ...
    methods: {
        filter: function filter() {
            ...
            axios.get('/api/publishers', {
                ...
                _this.publishers = res.data.data.data;
                _this.total_page = res.data.data.last_page;
            });
        },
        load: function load() {
            this.filter();
        },
        edit: function edit(pub) {
...
Component.options.__file = "resources/js/views/publishers/Create.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a0cdc976", Component.options)
  } else {
    hotAPI.reload("data-v-a0cdc976", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        save: function save() {
            ...
            axios.post('/api/publishers', this.publisher).then(function (res, rej) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "publisher" }, [
    _c(
      "form",
      {
        on: {
            ...
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.publisher.description,
                expression: "publisher.description"
              }
            ],
            staticClass: "form-control",
            attrs: { id: "description" },
            domProps: { value: _vm.publisher.description },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.publisher, "description", $event.target.value)
              }
            }
          })
        ]),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-a0cdc976", module.exports)
  }
}
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "publishers" }, [
    _c(
      "div",
      { staticClass: "container" },
      [
        _c("h3", [_vm._v("Publishers")]),
        _vm._v(" "),
        _c("hr"),
        _vm._v(" "),
        _c("a", {
          attrs: { href: "#" },
          domProps: {
            textContent: _vm._s(_vm.isEditMode ? "Cancel" : "Create new")
          },
          on: {
            click: function($event) {
              $event.preventDefault()
              _vm.publisher = _vm.publisher ? null : {}
            }
          }
        }),
        _vm._v(" "),
        _c("publisherForm", {
          ...
          attrs: { publisher: _vm.publisher }
        }),
        _vm._v(" "),
        _c(
          "ul",
          _vm._l(_vm.publishers, function(pub) {
            return _c("li", { key: pub.id }, [
              _c("div", [
                _c(
                  "h5",
                  {
                  ...
                  [_vm._v(_vm._s(pub.name))]
                ),
                _vm._v(" "),
                _c("p", [_vm._v(_vm._s(pub.description))])
              ])
            ])
          })
        ),
        _vm._v(" "),
        _c("pager", {
          attrs: { total_pages: _vm.total_page, uri: "/publishers" },
          on: { navigate: _vm.navigate }
        })
      ],
      1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9f4220fe", module.exports)
  }
}
